		...
		foreach ( $contexts as $context => $priorities ) {
			foreach ( $priorities as $priority => $boxes ) {
				foreach ( $boxes as $name => $data ) {
					...
					if ( isset( $metaboxes[ $page ][ $context ][ $priority ][ $name ]['callback'] ) && in_array( $metaboxes[ $page ][ $context ][ $priority ][ $name ]['callback'], $taxonomy_callbacks_to_unset, true ) ) {
						unset( $metaboxes[ $page ][ $context ][ $priority ][ $name ] );
					}
				}
			}
...
function gutenberg_is_metabox_empty( $metaboxes, $context, $post_type ) {
	...
	if ( isset( $metaboxes[ $page ][ $context ] ) ) {
